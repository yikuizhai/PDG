...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_a', type=str, default='/media/zhihao/F05CC6255CC5E706/dataset/few-shot-image-datasets/few-shot-images/100-shot-grumpy_cat')
    parser.add_argument('--path_b', type=str, default='/media/zhihao/Drive2ofZhiHao/PytorchPro/Discriminator_Guidance_for_GAN')
    ...
    for folder in range(args.iter,args.end+1):
        folder = 'eval_%d_ori'%(folder*10000)
